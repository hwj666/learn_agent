...
def extract_implicit_tool_calls(content: str, tools: Optional[List[Dict]] = None) -> List[Dict[str, Any]]:
...
def _normalize_tool_call(call_data: Dict, tools: Optional[List[Dict]] = None) -> Optional[Dict[str, Any]]:
    """规范化单个工具调用。"""
